...
To update the database use this command from the Web project folder (replace `ApiLearning` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../ApiLearning.Infrastructure/ApiLearning.Infrastructure.csproj -s ApiLearning.Web.csproj
```
